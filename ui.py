...
def create_ui():
    ...
    '''
    with gr.Blocks(analytics_enabled=False) as todolist_interface:
        with gr.Row():
        ...
        #dataFrame.select(create_dataframe, inputs=dataFrame, outputs=subitm)
    ...
    interfaces += [(todolist_interface,"GPTMovie","gptmovie")]
    '''
...
def get_shopplan_from_db():
    shotplan_list = []
    url ="http://192.168.6.100:9003/xvr/api/movie/sdtask/list"
    params = {
        "uobject_list" : 0
     }
